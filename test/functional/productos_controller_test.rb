...
class ProductosControllerTest < ActionController::TestCase
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post :create, producto: { garantia: @producto.garantia, margen: @producto.margen, nombre: @producto.nombre, precio: @producto.precio, stock: @producto.stock, stockOptimo: @producto.stockOptimo }
    end
  ...
  test "should update producto" do
    put :update, id: @producto, producto: { garantia: @producto.garantia, margen: @producto.margen, nombre: @producto.nombre, precio: @producto.precio, stock: @producto.stock, stockOptimo: @producto.stockOptimo }
    assert_redirected_to producto_path(assigns(:producto))
  end
